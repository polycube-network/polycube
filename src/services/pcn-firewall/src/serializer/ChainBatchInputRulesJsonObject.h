...
/*
* ChainBatchInputRulesJsonObject.h
*
*
*/
...
#ifndef OPERATIONENUM
#define OPERATIONENUM
enum class OperationEnum {
  INSERT, APPEND, DELETE, UPDATE
};
#endif
...
///
/// </summary>
class  ChainBatchInputRulesJsonObject : public JsonObjectBase {
 public:
  ChainBatchInputRulesJsonObject();
  ChainBatchInputRulesJsonObject(const nlohmann::json &json);
  ~ChainBatchInputRulesJsonObject() final = default;
  ...
  void setOperation(OperationEnum value);
  bool operationIsSet() const;
  void unsetOperation();
  static std::string OperationEnum_to_string(const OperationEnum &value);
  static OperationEnum string_to_OperationEnum(const std::string &str);
