...
public:
  ...
  static void create(Helloworld &parent, const std::string &name, const PortsJsonObject &conf);
  static std::shared_ptr<Ports> getEntry(Helloworld &parent, const std::string &name);
  static void removeEntry(Helloworld &parent, const std::string &name);
  static std::vector<std::shared_ptr<Ports>> get(Helloworld &parent);
  static void remove(Helloworld &parent);
