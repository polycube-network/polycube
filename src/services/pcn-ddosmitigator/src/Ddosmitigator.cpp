...
void Ddosmitigator::packet_in(Ports &port, polycube::service::PacketInMetadata &md, const std::vector<uint8_t> &packet){
  logger()->info("Ddosmitigator {0}: Packet received from port {1}", Cube::get_name(), port.name());
}
