...
public:
  ...
  static void create(Ddosmitigator &parent, const std::string &ip, const BlacklistSrcJsonObject &conf);
  static std::shared_ptr<BlacklistSrc> getEntry(Ddosmitigator &parent, const std::string &ip);
