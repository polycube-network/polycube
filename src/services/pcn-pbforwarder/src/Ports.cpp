...
void Ports::create(Pbforwarder &parent, const std::string &name, const PortsJsonObject &conf){
...
std::shared_ptr<Ports> Ports::getEntry(Pbforwarder &parent, const std::string &name){
