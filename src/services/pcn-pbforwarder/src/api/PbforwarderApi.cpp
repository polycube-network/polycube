...
Response read_pbforwarder_loglevel_by_id_handler(
  const char *name, const Key *keys,
  size_t num_keys ) {
  // Getting the path params
  std::string unique_name { name };
  ...
  try {
    ...
    auto x = read_pbforwarder_loglevel_by_id(unique_name);
    nlohmann::json response_body;
...
Response read_pbforwarder_ports_peer_by_id_handler(
  const char *name, const Key *keys,
  size_t num_keys ) {
  // Getting the path params
  std::string unique_name { name };
  ...
  try {
    ...
    auto x = read_pbforwarder_ports_peer_by_id(unique_name, unique_portsName);
    nlohmann::json response_body;
    response_body = x;
    return { kOk, ::strdup(response_body.dump().c_str()) };
  } catch(const std::exception &e) {
...
Response read_pbforwarder_ports_status_by_id_handler(
  const char *name, const Key *keys,
  size_t num_keys ) {
  // Getting the path params
  std::string unique_name { name };
  ...
  try {
    ...
    auto x = read_pbforwarder_ports_status_by_id(unique_name, unique_portsName);
    nlohmann::json response_body;
...
Response read_pbforwarder_ports_uuid_by_id_handler(
  const char *name, const Key *keys,
  size_t num_keys ) {
  // Getting the path params
  std::string unique_name { name };
  ...
  try {
    ...
    auto x = read_pbforwarder_ports_uuid_by_id(unique_name, unique_portsName);
    nlohmann::json response_body;
    response_body = x;
    return { kOk, ::strdup(response_body.dump().c_str()) };
  } catch(const std::exception &e) {
...
Response read_pbforwarder_type_by_id_handler(
  const char *name, const Key *keys,
  size_t num_keys ) {
  // Getting the path params
  std::string unique_name { name };
  ...
  try {
    ...
    auto x = read_pbforwarder_type_by_id(unique_name);
    nlohmann::json response_body;
...
Response read_pbforwarder_uuid_by_id_handler(
  const char *name, const Key *keys,
  size_t num_keys ) {
  // Getting the path params
  std::string unique_name { name };
  ...
  try {
    ...
    auto x = read_pbforwarder_uuid_by_id(unique_name);
    nlohmann::json response_body;
    response_body = x;
    return { kOk, ::strdup(response_body.dump().c_str()) };
  } catch(const std::exception &e) {
...
Response update_pbforwarder_loglevel_by_id_handler(
  const char *name, const Key *keys,
  size_t num_keys ,
  const char *value) {
  // Getting the path params
  ...
  try {
    auto request_body = nlohmann::json::parse(std::string { value });
    PbforwarderLoglevelEnum unique_value_ = PbforwarderJsonObject::string_to_PbforwarderLoglevelEnum(request_body);
    update_pbforwarder_loglevel_by_id(unique_name, unique_value_);
    return { kOk, nullptr };
  } catch(const std::exception &e) {
    return { kGenericError, ::strdup(e.what()) };
  }
...
Response update_pbforwarder_ports_peer_by_id_handler(
  const char *name, const Key *keys,
  size_t num_keys ,
  const char *value) {
  // Getting the path params
  ...
  try {
    ...
    update_pbforwarder_ports_peer_by_id(unique_name, unique_portsName, unique_value);
    return { kOk, nullptr };
  } catch(const std::exception &e) {
    return { kGenericError, ::strdup(e.what()) };
  }
