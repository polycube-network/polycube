...
class Ports : public polycube::service::Port, public PortsInterface {
 public:
  ...
  static void create(Pbforwarder &parent, const std::string &name, const PortsJsonObject &conf);
  static std::shared_ptr<Ports> getEntry(Pbforwarder &parent, const std::string &name);
