...
pbforwarder_add_rules_l2 0 27 pbf1
...
polycubectl pbforwarder pbf1 rules add 27 dst_mac=FF:FF:FF:FF:FF:FF action=FORWARD out_port=veth2

polycubectl pbforwarder pbf1 rules add 28 dst_mac=$veth1_mac action=FORWARD out_port=veth1

polycubectl pbforwarder pbf1 rules add 29 dst_mac=$veth2_mac action=FORWARD out_port=veth2
