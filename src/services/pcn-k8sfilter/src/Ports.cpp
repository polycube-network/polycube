...
void Ports::create(K8sfilter &parent, const std::string &name, const PortsJsonObject &conf){
...
std::shared_ptr<Ports> Ports::getEntry(K8sfilter &parent, const std::string &name){
