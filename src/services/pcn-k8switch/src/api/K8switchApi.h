...
Response read_k8switch_loglevel_by_id_handler(const char *name, const Key *keys, size_t num_keys);
...
Response read_k8switch_ports_peer_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response read_k8switch_ports_status_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response read_k8switch_ports_type_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response read_k8switch_ports_uuid_by_id_handler(const char *name, const Key *keys, size_t num_keys);
...
Response read_k8switch_type_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response read_k8switch_uuid_by_id_handler(const char *name, const Key *keys, size_t num_keys);
...
Response update_k8switch_loglevel_by_id_handler(const char *name, const Key *keys, size_t num_keys, const char *value);
...
Response update_k8switch_ports_peer_by_id_handler(const char *name, const Key *keys, size_t num_keys, const char *value);
