...
void Ports::create(K8switch &parent, const std::string &name, const PortsJsonObject &conf){
...
std::shared_ptr<Ports> Ports::getEntry(K8switch &parent, const std::string &name){
