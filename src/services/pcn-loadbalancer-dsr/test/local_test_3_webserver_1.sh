...
#config lb
polycubectl lbdsr lb1 ports add port1 type=FRONTEND
polycubectl lbdsr lb1 ports add port2 type=BACKEND
polycubectl lbdsr lb1 ports del port1
polycubectl lbdsr lb1 ports del port2
