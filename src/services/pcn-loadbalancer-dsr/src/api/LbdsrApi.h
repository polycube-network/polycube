...
Response read_lbdsr_loglevel_by_id_handler(const char *name, const Key *keys, size_t num_keys);
...
Response read_lbdsr_ports_peer_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response read_lbdsr_ports_status_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response read_lbdsr_ports_type_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response read_lbdsr_ports_uuid_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response read_lbdsr_type_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response read_lbdsr_uuid_by_id_handler(const char *name, const Key *keys, size_t num_keys);
...
Response update_lbdsr_loglevel_by_id_handler(const char *name, const Key *keys, size_t num_keys, const char *value);
...
Response update_lbdsr_ports_peer_by_id_handler(const char *name, const Key *keys, size_t num_keys, const char *value);
