...
bpf-iptables -I FORWARD -s 10.0.0.0/8 -j ACCEPT

sudo ip netns exec ns1 ping 10.0.2.1 -c 2 -W 2

bpf-iptables -D FORWARD -s 10.0.0.0/8 -j ACCEPT

test_fail sudo ip netns exec ns1 ping 10.0.2.1 -c 2 -W 2

bpf-iptables -A FORWARD -s 10.0.0.0/8 -j ACCEPT
...
bpf-iptables -I FORWARD 1 -s 10.0.0.0/8 -j ACCEPT
