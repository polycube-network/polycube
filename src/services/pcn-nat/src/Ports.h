...
class Ports : public polycube::service::Port, public PortsInterface {
 public:
  ...
  static void create(Nat &parent, const std::string &name, const PortsJsonObject &conf);
...
private:
  ...
  static void validateInternalPortParams(Nat &parent, const PortsJsonObject &conf);
  static void validateExternalPortParams(Nat &parent, const PortsJsonObject &conf);
};
