...
RuleSnat::RuleSnat(Rule &parent, const RuleSnatJsonObject &conf): parent_(parent) {
  update(conf);
}
...
void RuleSnat::update(const RuleSnatJsonObject &conf) {
  // This method updates all the object/parameter in RuleSnat object specified in the conf JsonObject.
...
void RuleSnat::create(Rule &parent, const RuleSnatJsonObject &conf){
  ...
  // Please remember to call here the create static method for all sub-objects of RuleSnat.
...
void RuleSnat::removeEntry(Rule &parent){
  ...
  // Remember to call here the remove static method for all-sub-objects of RuleSnat.
