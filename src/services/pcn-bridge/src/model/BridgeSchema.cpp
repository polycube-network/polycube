...
nlohmann::json BridgeSchema::getElements() {
    ...
    val["filteringdatabase"]["description"] = R"POLYCUBE(Entry associated with the filtering database)POLYCUBE";
  ...
  "x-key" : [ "vlan", "address" ]
    ...
    val["agingtime"]["description"] = R"POLYCUBE(Aging time of the filtering database)POLYCUBE";
  ...
  "description" : "Aging time of the filtering database"
    ...
    val["stpenabled"]["description"] = R"POLYCUBE(Enable/Disable the STP protocol of the bridge)POLYCUBE";
  ...
  "default" : false
    ...
    val["stp"]["type"] = "list";
    val["stp"]["description"] = R"POLYCUBE(Per-vlan Spanning Tree Protocol Configuration)POLYCUBE";
