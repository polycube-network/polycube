...
nlohmann::json StpSchema::getElements() {
    ...
    val["hellotime"]["description"] = R"POLYCUBE(Interval between transmissions of BPDU messages)POLYCUBE";
  ...
  "description" : "Interval between transmissions of BPDU messages"
    ...
    val["forwarddelay"]["description"] = R"POLYCUBE(Delay used by STP bridges for port state transition)POLYCUBE";
  ...
  "description" : "Bridge priority for STP"
    ...
    val["maxmessageage"]["description"] = R"POLYCUBE(Maximum age of a BPDU)POLYCUBE";
  ...
  "description" : "Maximum age of a BPDU"
    ...
    val["address"]["description"] = R"POLYCUBE(Main MAC address used by the STP)POLYCUBE";
