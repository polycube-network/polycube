...
polycubectl bridge br1 ports veth3 access set vlanid="20"
polycubectl bridge br1 ports veth4 access set vlanid="30"

polycubectl bridge br2 ports veth5 access set vlanid="10"
polycubectl bridge br2 ports veth6 access set vlanid="30"
polycubectl bridge br2 ports veth7 access set vlanid="40"
polycubectl bridge br2 ports veth8 access set vlanid="50"
polycubectl bridge br2 ports veth9 access set vlanid="50"


polycubectl bridge br3 ports veth10 access set vlanid="10"
polycubectl bridge br3 ports veth11 access set vlanid="40"
polycubectl bridge br3 ports veth12 access set vlanid="60"
polycubectl bridge br3 ports veth13 access set vlanid="60"


polycubectl bridge br1 ports link11 set mode="trunk"
polycubectl bridge br2 ports link12 set mode="trunk"
polycubectl bridge br2 ports link21 set mode="trunk"
polycubectl bridge br3 ports link22 set mode="trunk"


polycubectl bridge br1 ports link11 trunk allowed add 10
polycubectl bridge br1 ports link11 trunk allowed add 30
polycubectl bridge br2 ports link12 trunk allowed add 10
polycubectl bridge br2 ports link12 trunk allowed add 30

polycubectl bridge br2 ports link21 trunk allowed add 10
polycubectl bridge br2 ports link21 trunk allowed add 40
polycubectl bridge br3 ports link22 trunk allowed add 10
polycubectl bridge br3 ports link22 trunk allowed add 40
