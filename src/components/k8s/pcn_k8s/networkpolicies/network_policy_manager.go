...
func StartNetworkPolicyManager(clientset kubernetes.Interface, vPodsRange *net.IPNet, basePath, nodeName string, podController pcn_controllers.PodController) PcnNetworkPolicyManager {
