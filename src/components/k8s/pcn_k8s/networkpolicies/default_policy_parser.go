...
func (d *DefaultPolicyParser) generateRulesForPod(podsFound []pcn_types.Pod, pod *core_v1.Pod, generatedPorts []parsedProtoPort, direction string) pcn_types.ParsedRules {
