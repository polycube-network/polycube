...
project = u'Polycube'
copyright = u'2018-2021, The Polycube Authors'
...
latex_documents = [
    (master_doc, 'Polycube.tex', u'Polycube Documentation',
     u'The Polycube Authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'polycube', u'Polycube Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Polycube', u'Polycube Documentation',
     author, 'Polycube', 'One line description of project.',
     'Miscellaneous'),
]
